<template>
  <div class="p-4">
    <h1 class="text-2xl font-bold text-green-700 mb-4">Riwayat Transaksi</h1>

    <!-- Kosong -->
    <div v-if="riwayat.length === 0" class="text-gray-500 text-center mt-8">
      Belum ada transaksi 🍹<br />
      <span class="text-sm text-green-600 italic">Segarkan harimu dengan jus pertama!</span>
    </div>
    ...
    <div v-else class="space-y-6">
      <div
        ...
        :key="trx.id"
        class="bg-white rounded shadow p-4 border border-green-100"
      >
        <div class="flex justify-between items-center mb-2">
          <div>
            ...
            <p class="font-bold text-green-700">ID: {{ trx.id }}</p>
          </div>
